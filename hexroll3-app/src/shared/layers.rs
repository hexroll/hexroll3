...
pub const HEIGHT_OF_REALM_BORDERLINES: f32 = HEIGHT_OF_TOP_MOST_LAYERED_TILE - 1.0;
pub const HEIGHT_OF_HEX_MARKER: f32 = 118.0;
pub const HEIGHT_OF_POI_LABELS: f32 = 119.0;
